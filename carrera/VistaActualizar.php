...
<div class="container" style="padding: 20px 20px;">
    ...
    id="formulario2" name="formulario2" class="needs-validation" novalidate>
    ...
    <div class="form-group input-group">
        ...
        <input type="number" name="clave" class="form-control" placeholder="Ingrese Numero clave" pattern ="\{1,99}/" value="<?php echo $campo2;?>" required>
    ...
    <div class="form-group input-group">
        ...
        <input type="number" name="clavedgp" class="form-control" placeholder="Ingrese la clave DGP" pattern ="\{1,99}/" value="<?php echo $campo7;?>" required>
    ...
    <div class="form-group input-group">
        ...
        <input type="text" name="nombre" class="form-control" placeholder="Ingrese Nombre Carrera" pattern="[a-zA-ZÀ-ÿ\s.,]{1,120}" value="<?php echo $campo3;?>" required>
    ...
    <div class="form-group input-group">
        ...
        <input type="text" name="descripcion" class="form-control" placeholder="Ingrese Descripción" pattern ="[a-zA-ZÀ-ÿ\s.,]{1,120}"  value="<?php echo $campo4;?>" required>
    ...
    <div class="form-group input-group">
     ...
     <select name="activo" class="form-control" required>
      <option selected value="">Seleciones estatus</option>
    ...
    <div class="form-group input-group">
        ...
        <input maxlength="3" type="text" name="siglas" class="form-control" placeholder="Ingrese Siglas" pattern ="[a-zA-ZÀ-ÿ\s]{1,3}" value="<?php echo $campo6;?>" required>
    ...
    <div class="cols-4">
		<input style="font-size: 18px;" type="Submit" class="btn btn-primary btn-block" 
         value="Actualizar" name="btnActualizar" id="btnActualizar"
        >
    </div> 
